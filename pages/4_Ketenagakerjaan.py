...
st.title('Statistik Ketenagakerjaan :blue[Kota Cimahi]')
...
with kol1a:
    with st.container(border=True):
        st.success('Tren Tingkat Pengangguran Terbuka (TPT) Kota Cimahi dan Jawa Barat')
...
with kol1b:
    with st.container(border=True):
        st.info('Tren Tingkat Partisipasi Angka Kerja (TPAK) Kota Cimahi dan Jawa Barat')
...
with st.expander('Lihat Tabel Lengkap'):
    st.warning('Indikator Ketenagakerjaan Makro Kota Cimahi dan Jawa Barat')
