...
st.title('Statistik Pariwisata :blue[Kota Cimahi]')
...
with kol1a:
    with st.container(border=True):
        st.success('Tingkat Penghunian Kamar (TPK) Hotel Kota Cimahi')
...
with kol1b:
    with st.container(border=True):
        st.info('Tingkat Pemakaian Tempat Tidur (TPTT) Hotel Kota Cimahi')
...
with st.expander('Rata-rata Lama Menginap Tamu'):        
    ...
    with kol2a:
        with st.container(border=True):
            st.success('Rata-rata Lama Menginap Tamu Asing (RLMTA) di Hotel Kota Cimahi')
    ...
    with kol2b:
        with st.container(border=True):
            st.info('Rata-rata Lama Menginap Tamu (RLMT) di Hotel Kota Cimahi')
    ...
    with kol2c:
        with st.container(border=True):
            st.success('Rata-rata Lama Menginap Tamu Dalam Negeri (RLMTD) di Hotel Kota Cimahi')
...
with st.expander('Jumlah Tamu'):
    ...
    with kol3a:
        with st.container(border=True):
            st.success('Jumlah Tamu Asing - Hotel Kota Cimahi')
    ...
    with kol3b:
        with st.container(border=True):
            st.info('Jumlah Tamu Dalam Negeri - Hotel Kota Cimahi')
...
with st.expander('Lihat Tabel Lengkap'):
    st.warning('Statistik Pariwisata Kota Cimahi')
