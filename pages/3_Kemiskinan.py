...
st.title('Kemiskinan Makro :blue[Kota Cimahi]')
...
with kol1a:
    with st.container(border=True):
        st.success('Perkembangan Jumlah Penduduk Miskin di Kota Cimahi')
...
with kol1b:
    with st.container(border=True):
        st.info('Garis Kemiskinan Kota Cimahi')
...
with st.expander('Lihat Tabel Lengkap'):
    st.success('Indikator Kemiskinan Makro Kota Cimahi')
