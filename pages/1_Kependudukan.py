...
st.title(':orange[STATISTIK] :blue[KEPENDUDUKAN] :green[KOTA CIMAHI]')
...
with st.container(border=True):
    # URL API Open Data
    url = "https://data.jabarprov.go.id/api-backend//bigdata/disdukcapil_2/od_17892_jml_penduduk__jk_kabupatenkota?limit=1000&skip=0&where=%7B%22kode_kabupaten_kota%22%3A%5B%223277%22%5D%7D"
    ...
    st.subheader('Perkembangan Jumlah Penduduk Kota Cimahi')
    ...
    # KELOMPOK UMUR
    with tab3:
        url3 = 'https://data.jabarprov.go.id/api-backend//bigdata/disdukcapil_2/od_18305_jml_penduduk__kelompok_umur_kabupatenkota?limit=1000&skip=0&where=%7B%22kode_kabupaten_kota%22%3A%5B%223277%22%5D%7D'
        ...
        if pilihan:
            st.subheader(f'Penduduk Kota Cimahi menurut Kelompok Umur Tahun {pilihan}')
    ...
    # STATUS KAWIN    
    with tab4:
        st.subheader('Penduduk Kota Cimahi menurut Status Kawin')
        url4 = 'https://data.jabarprov.go.id/api-backend//bigdata/disdukcapil_2/od_15135_jumlah_penduduk_berdasarkan_status_perkawinan_v1?limit=3000&skip=0&where=%7B%22kode_kabupaten_kota%22%3A%5B%223277%22%5D%7D'
