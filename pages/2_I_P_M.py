...
st.title('Indikator Pembangunan Manusia :blue[Kota Cimahi]')
...
with st.container(border=True):
    st.success('Tren IPM Kota Cimahi')
...
with kol1a:
    with st.container(border=True):
        st.info('Tren Pengeluaran Perkapita Disesuaikan (000 Rp) Kota Cimahi')
...
with kol1b:
    with st.container(border=True):
        st.warning('Pertumbuhan IPM Kota Cimahi (%)')
...
with kol2a:
    with st.container(border=True):
        st.warning('Tren Lama Sekolah di Kota Cimahi')
...
with kol2b:
    with st.container(border=True):
        st.info('Tren Usia Harapan Hidup (UHH) di Kota Cimahi')
...
with st.expander('Lihat Tabel Lengkap'):
    st.success('Indikator Pembangunan Manusia Kota Cimahi')
